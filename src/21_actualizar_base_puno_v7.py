...
def main():
    print("Iniciando actualización de base Puno...")
    ...
    df_nuevos = df_nuevos[df_nuevos['departamento_consulta'].str.upper() == 'PUNO']
    ...
    # 3. Cargar v6 anterior para cruzar información enriquecida (avance físico, coordenadas, eps)
    df_v6 = pd.read_csv('outputs/proyectos_agua_saneamiento_puno_v6.csv', dtype=str)
    ...
    # Guardar
    out_path = 'outputs/proyectos_agua_saneamiento_puno_v7.csv'
