...
# Archivos
CSV_FILE = Path("outputs/proyectos_agua_saneamiento_puno_v5.csv")
...
def main():
    ...
    for u in df_valid['UBIGEO_NORMALIZADO'].unique():
        ...
        for _, p in proys_u.iterrows():
            ...
            elif len(fec) > 10: fec = fec[:10] # e.g. 2022-01-16
